...
public class MathUtils {
    ...
    static private final int SIN_BITS = 14; // 16 KB. Adjust for accuracy.
    ...
    /**
     * @return the largest integer less than or equal to the specified float. This method will only properly floor floats from -(2^14) to (Float.MAX_VALUE - 2^14).
     */
    ...
    /**
     * @return The largest integer less than or equal to the specified float. This method will only properly floor floats that are positive. Note this method simply casts the float to int.
     */
    ...
    /**
     * @return The smallest integer greater than or equal to the specified float. This method will only properly ceil floats from -(2^14) to (Float.MAX_VALUE - 2^14).
     */
    ...
    /**
     * @return the smallest integer greater than or equal to the specified float. This method will only properly ceil floats that are positive.
     */
    ...
    /**
     * @return The closest integer to the specified float. This method will only properly round floats from -(2^14) to (Float.MAX_VALUE - 2^14).
     */
    ...
    /**
     * @return The rounded number to a set decimal place
     */
    static public Double round(float x, int decPlaces) {
        if (decPlaces < 0) throw new IllegalArgumentException();
        BigDecimal bd = BigDecimal.valueOf(x);
        bd = bd.setScale(decPlaces, RoundingMode.HALF_DOWN);
        return bd.doubleValue();
    }

    /**
     * @param percent Chance
     * @return True or False depending on chance
     */
     ...
     * @return The distance (difference) between the locations in 2D Space (i.e. distanceSquared)
     */
     ...
     * @param loc1 First location
     * @param loc2 Second location
     * @return The distance (difference) between the locations in 3D space (absolute distance)
     */
